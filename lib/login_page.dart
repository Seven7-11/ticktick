...
import 'package:ticktick/screens/singup_page.dart';
import 'package:ticktick/screens/activity_page.dart'; // ✅ เพิ่มการ import activity_page.dart
...
class _MyAppState extends State<MyApp> {
  bool isDarkMode = false; // กำหนดค่าเริ่มต้นของ dark mode
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      themeMode: isDarkMode ? ThemeMode.dark : ThemeMode.light, // ใช้ค่าของ isDarkMode
      home: LoginPage(
        isDarkMode: isDarkMode,
        onThemeChanged: (bool value) {
          setState(() {
            isDarkMode = value; // อัพเดตค่า dark mode
          });
        },
      ),
    );
